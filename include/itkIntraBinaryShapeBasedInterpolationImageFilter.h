...
#ifndef __INTRABINARYSHAPEBASEDINTERPOLATIONIMAGEFILTER_H
#define __INTRABINARYSHAPEBASEDINTERPOLATIONIMAGEFILTER_H
...
namespace itk
{
  ...
  * This filter takes as input a 3D binary image wherein the object of interest is represented in full, 
  * that is, on all contiguous slices that comprise it. Such filter yields an upsampled 3D binary image 
  ...
  */
  ...
  public:           
    ...
    typedef typename IntermediateImageType::SpacingType               IntermediateSpacingType; 
  ...
  protected:
    ...
    // Find all slices that are delineated (i.e. wherein there exist non-zero pixel intensities). 
...
#endif  // #define __INTRABINARYSHAPEBASEDINTERPOLATIONIMAGEFILTER_H